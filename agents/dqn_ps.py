...
class AgentDQNSA(Agent):
    ...
    def __init__(self, dataset: InternalKB, switch_thres, config, n_chances=20, lr=5e-4, load_path=None, mode='train'):
        super(AgentDQNSA, self).__init__(dataset, n_chances, switch_thres)
    ...
    def question(self):
        ...
        if done and self.guess_right:
            ...
            self.KB_update_periodic(self.guess, self.episode_log['question'], self.episode_log['response'], 1)   # 50000
